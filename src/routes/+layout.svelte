...
<div class="bg-gray-900 text-gray-300 font-sans">
    <!-- Header -->
    <header
        class="bg-gray-900/80 backdrop-blur-sm fixed top-0 left-0 right-0 z-50 border-b border-gray-700/50"
    >
        <div
        ...
        <!-- Mobile Menu -->
        {#if isMobileMenuOpen}
            <div class="fixed inset-0 bg-gray-900/95 pt-20 md:hidden">
